...
class MushRoomDialogConfirmWidget extends StatefulWidget {
  const MushRoomDialogConfirmWidget({
    Key? key,
    required this.error,
  ...
  @override
  State<MushRoomDialogConfirmWidget> createState() =>
      _MushRoomDialogDioExceptionWidgetState();
}

class _MushRoomDialogDioExceptionWidgetState
    extends State<MushRoomDialogConfirmWidget> {
  @override
