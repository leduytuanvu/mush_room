...
import 'package:mush_room/core/utils/app_themes.dart';  // <-- Import AppTheme
...
class ThemeBloc extends Bloc<ThemeEvent, ThemeState> {
  ...
  ThemeBloc(this._sharedPreferenceService) : super(
      _sharedPreferenceService.getTheme() == 'dark'
  ...
  Stream<ThemeState> mapEventToState(
    ...
    if (event is ThemeLightModeEnabled) {
      ...
      _sharedPreferenceService.setTheme('light');
    } else if (event is ThemeDarkModeEnabled) {
      yield ThemeState(AppTheme.darkTheme);
      _sharedPreferenceService.setTheme('dark');
    }
  }
}
