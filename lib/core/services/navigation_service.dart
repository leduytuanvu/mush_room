...
class NavigationService {
  ...
  BuildContext currentContext() {
    return navigationKey.currentState!.overlay!.context;
  }
  ...
  Future<dynamic> navigateToScreen(String name, {arguments}) async =>
  ...
  Future<dynamic> replaceScreen(String name, {arguments}) async =>
